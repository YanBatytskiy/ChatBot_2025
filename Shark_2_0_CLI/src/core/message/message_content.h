 ...
 */
template <typename T>
class MessageContent : public IMessageContent {
private:
...
public:
   ...
   */
  const T &getMessageContent() const {
    return _content;
  };
   ...
   */
  void setMessageContent([[maybe_unused]] const T &content) {}; // for edit of message, will be realized further
};
