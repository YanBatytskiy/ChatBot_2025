 ...
 */
bool addMessageToChatInit([[maybe_unused]] ServerSession &serverSession, const InitDataArray &initDataArray,
  ...
  try {
    ...
    std::cout << " ! " << ex.what()
              << "Sender is missing. Message will not be "
                 "created. addMessageToChatInit"
              << std::endl;
    return false;
...
void systemInitForTest(ServerSession &serverSession) {
  ...
  // Create chat lists for the users
  ...
  // Create the first chat: Sasha and Elena (one-on-one)
  ...
  InitDataArray Elena_Alex1("Hello", ts, Elena1510_ptr, recipients, 0);
  ...
  InitDataArray Elena_Alex2("Hi! how are things?", ts, Alex2104_ptr, recipients, 0);
  ...
  InitDataArray Elena_Alex3("Good, how about some coffee?", ts, Elena1510_ptr, recipients, 0);
  ...
  // Create the second chat: Elena, Sasha and Sergei (group chat)
  chat_ptr.reset();
  recipients.clear();
  participants.clear();
  ...
  InitDataArray Elena_Alex_Serg1("Hiiii everyone!?", ts, Elena1510_ptr, recipients, 0);
  ...
  InitDataArray Elena_Alex_Serg2("Stay well yourself!?", ts, Alex2104_ptr, recipients, 0);
  ...
  InitDataArray Elena_Alex_Serg3("Howdy everyone.", ts, Serg0101_ptr, recipients, 0);
  ...
  InitDataArray Elena_Alex_Serg4("Where are we going?", ts, Elena1510_ptr, recipients, 0);
  ...
  InitDataArray Elena_Alex_Serg5("To the movies!", ts, Serg0101_ptr, recipients, 0);
