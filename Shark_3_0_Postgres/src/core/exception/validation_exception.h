...
public:
   ...
   */
  UnknownException([[maybe_unused]] const std::string &str) : ValidationException("Unknown error.") {};
};
...
public:
   ...
   */
  BadWeakException([[maybe_unused]] const std::string &str) : ValidationException("weak_ptr lost.") {};
};
