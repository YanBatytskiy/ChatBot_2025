...
bool User::getIsActive() const {
  return _userData._isActive;
}

std::int64_t User::getDisabledAt() const {
  return _userData._disabledAt;
}

std::int64_t User::getBunUntil() const {
  return _userData._bunUntil;
}
