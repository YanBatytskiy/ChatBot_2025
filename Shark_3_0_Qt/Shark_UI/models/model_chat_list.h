...
public:
  ...
  static QString buildInfoTextForRow(const QString &chatIdStr,
                                     const QString &unreadCountStr,
                                     const QString &lastTimeStr);

  void fillChatListItem(const QString &participantsChatList,
                        const QString &infoText, const int &unreadCount,
                        bool isMuted, std::int64_t lastTime,
                        std::size_t chatId);
