...
QVariant MessageModel::data(const QModelIndex &index, int messageRole) const {
  ...
  switch (messageRole) {
    case MessageTextRole:
      return it.MessageText;
    case SenderLoginRole:
      return it.SenderLogin;
    case SenderNameRole:
      return it.SenderName;
    case TimeStampRole:
      return static_cast<qlonglong>(it.TimeStamp);
    case MessageIdRole:
      return static_cast<qlonglong>(it.MessageId);
  }
  return {};
}
